...
public class LoginFinal extends JPanel{
    ...
    public void crear(){
         ...
         c3.insets = new Insets(4,200,4,200);  //top padding
         ...
         c4.fill = GridBagConstraints.CENTER;  //natural height, maximum width
         ...
         c5.insets = new Insets(4,200,4,200);  //top padding
         ...
         c6.insets = new Insets(4,200,4,4);  //top padding
         ...
         c7.insets = new Insets(4,4,4,200);  //top padding
